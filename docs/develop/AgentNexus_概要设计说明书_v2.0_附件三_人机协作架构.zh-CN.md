> **语言**：中文 | [English](AgentNexus_概要设计说明书_v2.0_附件三_人机协作架构.md)
...
| v1\.1 | 2026\-03\-16 | 按代码实现补充对齐：当前主可用协作模式为 Coordinator + 澄清卡片 + 自动接手；/anchor、/decide 等指令与 Task DAG 全流程仍属规划能力。 |
