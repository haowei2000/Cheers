# Agent Self-Enrollment Protocol Summary

> **Language**: English | [中文](附件四_Agent自主加入协议摘要.zh-CN.md)

Summary of the planned agent self-enrollment protocol.
