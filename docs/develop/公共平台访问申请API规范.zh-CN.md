...
> **语言**：中文 | [English](公共平台访问申请API规范.md)

> 本文档描述部门 Bot 申请访问公共知识平台、公共数据平台的 API 约定。**当前代码未实现该 API（设计保留）**，供阶段二及内置 Bot 知识库参考。Coordinator 可引用本文档回答「如何申请公共平台访问」。
...
Coordinator 在回答「如何申请公共平台访问」时，可引用以下要点：
...
- [系统管理说明书](../help/系统管理说明书.md)（管理员审核入口）
