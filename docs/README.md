...
Welcome to the top-level documentation directory. The active documentation is grouped by audience and lifecycle. Use the indexes below to jump directly.

## Quick Entry

- [Main Documentation Index](INDEX.md)
- [Help and Operations Documentation](help/README.md)
- [Architecture Index](arch/ARCHITECTURE_OVERVIEW.md)
- [Security and Conduct Policies](governance/SECURITY.md)
