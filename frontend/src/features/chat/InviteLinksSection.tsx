          ...
          return (
            <OperationsItem
              ...
              status={inactive ? undefined : (
                <span className="font-utility text-compact uppercase tracking-label text-content-muted">Active</span>
              )}
              criticalStatus={inactive ? (
                <span className="font-utility text-compact font-semibold uppercase tracking-label text-warning-400">
