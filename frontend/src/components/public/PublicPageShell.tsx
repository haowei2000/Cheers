...
export const publicLabelClass =
  "font-utility text-[11px] font-semibold text-zinc-400 uppercase tracking-[0.1em]";
    ...
    <main className="public-edition h-full overflow-y-auto bg-zinc-950 text-zinc-100">
      <div className="mx-auto grid min-h-full w-full max-w-6xl gap-x-16 md:grid-cols-[minmax(260px,0.8fr)_minmax(380px,1.2fr)]">
        <aside className="hidden px-8 py-9 md:flex md:flex-col">
          <Link to="/" className="font-masthead text-xl tracking-[0.01em] text-zinc-100">
            Cheers
          </Link>
          <div className="mt-auto max-w-xs border-t border-zinc-800 pt-5">
            ...
            <p className="font-reading mt-3 text-[15px] leading-6 text-zinc-400">
          ...
          <div className={width === "wide" ? "w-full max-w-xl" : "w-full max-w-md"}>
            <div className="mb-6 border-b border-zinc-800 pb-5">
              <div className="mb-8 flex items-center justify-between md:hidden">
                <Link to="/" className="font-masthead text-lg text-zinc-100">
                  Cheers
                </Link>
                <span className="font-utility text-[10px] uppercase tracking-[0.12em] text-zinc-600">
                  Web edition
                </span>
              </div>
              <p className="font-utility text-[10px] font-semibold uppercase tracking-[0.14em] text-zinc-500">
              ...
              <h1 className="font-masthead mt-2 text-[clamp(2.25rem,7vw,3.75rem)] font-normal leading-[0.98] tracking-[0.005em] text-zinc-50">
                {title}
              </h1>
              {description && (
                <p className="font-reading mt-3 max-w-[44ch] text-[15px] leading-6 text-zinc-400">
                  {description}
                </p>
              )}
            </div>
