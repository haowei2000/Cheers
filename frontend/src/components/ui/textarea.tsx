...
// Filled textarea with the same borderless resting state as Input.
export const Textarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
  ({ error, controlSize, className, ...props }, ref) => {
    ...
    <textarea
      ref={ref}
      className={cn(
        "w-full rounded-sm bg-zinc-800 px-3 py-2 text-comfortable md:text-regular text-content-primary placeholder-zinc-400 transition-shadow",
