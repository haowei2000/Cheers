...
export function ResizeGrip({ resizeProps }: { resizeProps: WindowDrag["resizeProps"] }) {
  return (
    <div
      {...resizeProps}
      title="Resize"
      className="absolute bottom-0 right-0 z-10 flex h-4 w-4 cursor-se-resize items-end justify-end p-1 text-zinc-500 hover:text-zinc-300 select-none max-md:hidden"
    >
