...
> **Language**: English | [中文](FRONTEND.zh-CN.md)

Frontend component hierarchy and reuse conventions for the main React application.
...
- Message rendering and Composer boundaries
- API, hooks, and type ownership
