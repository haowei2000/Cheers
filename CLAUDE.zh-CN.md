...
docker build -t cheers/frontend:dev --build-arg VITE_API_BASE_URL=/api/v1 -f frontend/Dockerfile .  # gateway 用：docker build -t cheers/gateway:dev -f server/Dockerfile .
