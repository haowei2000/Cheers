...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            desktop_auth::desktop_login_flow_passkey_verify,
            desktop_auth::desktop_login_flow_password,
            desktop_auth::desktop_login_flow_code,
            desktop_auth::desktop_login_flow_email_send,
            desktop_auth::desktop_start_step_up,
            desktop_auth::desktop_step_up_password,
            desktop_auth::desktop_step_up_code,
            desktop_auth::desktop_step_up_email_send,
            desktop_auth::desktop_step_up_passkey_options,
            desktop_auth::desktop_step_up_passkey_verify,
            desktop_auth::desktop_cancel_step_up,
